            ...
            for (auto &I : B) {
                if (auto *CI = dyn_cast<CallInst>(&I)) {
                    ...
                    if (maskedFunction &&
                        ...
                        auto *unmaskedLoad = new LoadInst(maskedFunction->getReturnType(),
                        ...
                        auto  cmpInst = new ICmpInst(unmaskedLoad, CmpInst::ICMP_EQ, castInst,
                                                     ConstantInt::get(castInst->getType(), 0), "");
                        ...
                        auto selectInst = SelectInst::Create(
                            mask, unmaskedLoad, UndefValue::get(unmaskedLoad->getType()), "", CI);
